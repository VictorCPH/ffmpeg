...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " See av_get_chroma_sub_sample() for a function that asserts a"]
    #[doc = " valid pixel format instead of returning an error code."]
    #[doc = " Its recommended that you use avcodec_get_chroma_sub_sample unless"]
    #[doc = " you do check the return code!"]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " @param dst_linesizes linesizes for the image in dst_data to be filled in"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @param[in] align the assumed linesize alignment"]
